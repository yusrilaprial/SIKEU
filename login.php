...
<head>
  ...
  <style>
    body{background-image:url(img/trac.jpg);
            ...
            <!-- Nested Row within Card Body -->
                ...
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">PENCATATAN KEUANGAN</h1>
                  </div>
                  <form class="user" action="proses-login.php" method="post">
                    ...
                    <div class="form-group">
                      <div class="custom-control custom-checkbox small" style="visibility: hidden;">
