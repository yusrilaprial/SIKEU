...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 03 Jul 2022 pada 09.09
...
(1, 'Yusril', 'admin@gmail.com', 'admin'),
(2, 'Yanto', 'pegawai@gmail.com', 'pegawai');
...
(4, 'Pastikan pada tanggal 10 pengeluaran bulan sebelumnya dilaporkan pada atasan');
...
(18, 200000000, '2022-06-14', 'Modal Tambahan', 'Bank BRI');
...
(1, '0000-00-00', 100000, 1),
(2, '0000-00-00', 500000, 4),
...
(24, '2022-04-12', 2000000, 5),
(25, '2022-04-15', 300000, 5),
(26, '2022-04-11', 233333, 1),
(27, '2022-04-09', 567890, 1),
(28, '2022-04-06', 586876868, 3),
(29, '2022-04-11', 666666, 3),
(30, '2022-04-10', 8000000, 4),
(31, '0000-00-00', 6000000, 1),
(32, '2022-04-17', 6000000, 4),
(33, '2022-04-17', 800000, 4),
(34, '2022-04-16', 600000, 1),
(35, '2022-04-15', 700000, 5),
(36, '2022-04-13', 800000, 4),
(37, '2022-04-15', 700000, 3),
(38, '2022-04-16', 6000000, 3),
(39, '2022-04-11', 500000, 4),
(40, '2022-04-11', 100000, 1),
(41, '2022-04-12', 2000000, 4),
(42, '2022-04-13', 500000, 5),
(43, '2022-04-14', 9000000, 2),
(44, '2022-06-10', 200000, 2),
(45, '2022-06-09', 300000, 5),
(47, '2022-06-08', 200000, 4),
(48, '2022-06-11', 200000, 2);
...
(20, '2022-04-12', 1000000, 7),
(21, '2022-04-15', 475999, 8),
(22, '2022-04-11', 234567, 7),
(23, '2022-04-10', 777777, 8),
(24, '2022-04-14', 230000000, 10),
(25, '2022-06-11', 2000000, 6);
...
(1, 'Jasa Rental Mobil Korporat'),
(2, 'Jasa Rental Mobil Harian'),
(3, 'Jasa Sewa Bus'),
(4, 'Jasa Sewa Pengemudi'),
(5, 'Pendapatan Lainnya'),
(6, 'Biaya Alat Kerja Kantor'),
(7, 'Biaya Iklan dan Pemasaran'),
(8, 'Biaya Gaji Karyawan'),
(9, 'Biaya Pajak dan Hutang'),
...
--
ALTER TABLE `pemasukan`
  MODIFY `id_pemasukan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
